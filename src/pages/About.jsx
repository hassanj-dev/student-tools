      ...
      <section className="ab-hero glass">
        <div className="ab-hero-copy">
          ...
          <p className="muted ab-lead">
            SparkDesk was born out of frustration — too many tabs, too many apps,
            and not enough time. We built the toolkit we wish existed when we were studying.
          </p>
      ...
      <section className="ab-section glass">
        ...
        <div className="ab-story-grid">
          <div className="ab-story-text">
            <p>It started the night before finals. Three tabs open: one to calculate GPA, one to format a resume, one to create flashcards. Each site either had a paywall, was full of ads, or was outdated.</p>
            <p>We thought: what if one platform had everything a student actually needs — clean, fast, and completely free?</p>
            <p>That idea became SparkDesk. We built the first version in a weekend and shared it with classmates. The response was immediate.</p>
            <p>Today, SparkDesk is used by students across universities worldwide and keeps growing every day with student feedback.</p>
          </div>
        ...
        <div className="ab-tools-grid">
          {tools.map((t, i) => (
            <div className="ab-tool glass" key={i}>
              ...
              <h4>{t.title}</h4>
              <p className="muted" style={{ fontSize: ".87rem" }}>{t.desc}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="ab-values-grid">
          {values.map((v, i) => (
            <div className="ab-value glass" key={i}>
              ...
              <h4>{v.title}</h4>
              <p className="muted" style={{ fontSize: ".87rem" }}>{v.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="ab-cta">
        <div className="ab-cta-inner">
          ...
          <p style={{ color: "rgba(255,255,255,.65)", marginBottom: 28 }}>
            Join thousands of students already using SparkDesk — free, forever.
          </p>
